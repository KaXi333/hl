<template>
  <div>
    ...
    <div v-if="msTime.show" class="home__banner__countdown">
      <span class="widget__countdown">{{msTime.day}}
        <span class="widget__countdown__sub">日</span>&nbsp;
        <span class="widget__countdown__sub">:</span>{{msTime.hour}}
        <span class="widget__countdown__sub">时</span>&nbsp;
        <span class="widget__countdown__sub">:</span>{{msTime.minutes}}
        <span class="widget__countdown__sub">分钟</span>&nbsp;
        <span class="widget__countdown__sub">:</span>{{msTime.seconds}}
        <span class="widget__countdown__sub">秒钟</span></span>
    </div>
